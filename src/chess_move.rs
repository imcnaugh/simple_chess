...
impl<'a> ChessMove<'a> {
    pub fn build(original_pos: (usize, usize), new_pos: (usize, usize), piece: &'a ChessPiece, takes: Option<&'a ChessPiece>) -> Self {
        ChessMove{
...
impl<'a> Display for ChessMove<'a> {
    fn fmt(&self, f: &mut Formatter<'_>) -> std::fmt::Result {
        ...
        write!(f, "{:?} {:?} {} {} from {}",
               ...
               action,
               format!("{}{}", (self.new_position.0 as u8 + b'a') as char, (self.new_position.1 as u8 + b'1') as char),
               format!("{}{}", (self.original_position.0 as u8 + b'a') as char, (self.original_position.1 as u8 + b'1') as char))
    }
}